...
export default class FaturasForm extends React.Component {
  ...
  _onPressButton() {
    this.props.navigate(this.props.faturaID)
  }
        ...
        <View style={styles.rowA}> 
          ...
          <View style={styles.childrenB}>   
            ...
            <View style={styles.text}>
              ...
              <View style={{marginBottom: 5}}>
                <Text style={{color: "#737373"}}> Faturado: {this.props.totalDoc}€</Text> 
              </View>      
