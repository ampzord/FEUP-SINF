...
export default class OrcamentoForm extends React.Component {
  ...
  _onPressButton() {
    this.props.navigate(this.props.orcamentoId)
        ...
        <View style={styles.rowA}> 
          ...
          <View style={styles.childrenB}>   
            ...
            <View style={styles.text}>
              ...
              <View style={{marginBottom: 5}}>
                <Text style={{color: "#737373"}}> Codigo: #201800{this.props.numDoc}</Text> 
              </View>
              <View style={{marginBottom: 5}}>
                <Text style={{color: "#737373"}}> Inicio: {moment(this.props.dataCriacao).format('DD/MM/YYYY')}</Text>
              </View>
