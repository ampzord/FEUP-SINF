...
export default class CreateFaturaScreen extends React.Component {
  ...
  constructor(props) {
   ...
   _onPressButton() {
    fetch(global.serverUrl + '/sales/invoices', {
      ...global.postOptions,
      body: JSON.stringify({
    ...
    .then(response => {
      if (response.status === 200) {
        Alert.alert('Fatura criada!')
        let reload = this.props.navigation.getParam('reload', () => {})

        reload()
        this.props.navigation.navigate('FaturaList')
      } else {
       ...
       <View style={styles.paper}>
        ...
        <View style={styles.rowA}> 
          ...
          <View style={styles.childrenA}>
              <ImageBackground source={require('../assets/images/fat.png')} style={styles.bg}>     
              </ImageBackground>
          </View>
